...
def main():
    """
        It reads the db credentials from the config file, connects to the database, loads the s3 files into sage tables, loads the final tables from   stage tables and closes the database connection.
    """
